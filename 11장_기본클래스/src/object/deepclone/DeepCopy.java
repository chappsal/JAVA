...
class Point implements Cloneable{ //점   // 1.객체를 복제할 수 있는 클래스
	...
	@Override
	protected Point clone() throws CloneNotSupportedException { //throws : 던져줌
...
class Rectangle implements Cloneable { //사각형
	...
	protected Rectangle clone() throws CloneNotSupportedException { 
		return (Rectangle)super.clone(); //Object의 clone() 메서드 : 얕은 복제 					
	}
	*/
	 ...
	 */
	@Override
	protected Rectangle clone() throws CloneNotSupportedException { //throws : 던져줌   //Object -> Point
		//1. 먼저 얕은 복제로 객체를 통째로 복사
		Rectangle cpy = (Rectangle)super.clone();
		
		//2. upperLeft와 lowerRight가 참조하는 Point 객체를 복사
